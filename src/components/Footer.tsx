const Footer = () => (
  <footer className="footer footer-center w-full mt-auto p-4 bg-base-300 text-base-content">
    <aside>
      <p>Copyright © 2023 - Dmitri Sim</p>
      <a
        href="https://gitlab.com/dsim/yolo-country-lookup"
        target="_blank"
        rel="noreferrer">
        <svg
